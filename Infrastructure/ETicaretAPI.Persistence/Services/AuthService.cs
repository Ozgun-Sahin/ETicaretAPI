...
namespace ETicaretAPI.Persistence.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IHttpClientFactory httpClientFactory, IConfiguration configuration, UserManager<u.AppUser> userManager, ITokenHandler tokenHandler, SignInManager<AppUser> signInManager, IUserService userService, IMailService mailService)
        {
        ...
        public async Task<Token> GoogleLoginAsync(string idToken, int accessTokenLifeTime)
        {
            ...
            var payload = await GoogleJsonWebSignature.ValidateAsync(idToken, setttings);
        ...
        public async Task PasswordResetAsync(string email)
        {
            ...
            if (user != null)
            {
                ...
                await _mailService.SendPassowdResetMailAsync(email, user.Id, resetToken);
            }
        }
